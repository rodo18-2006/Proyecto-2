          ...
          <Card className="caard">
            <Card.Body>
              ...
              <Card.Text>
                ...
                rendimiento, la Dra. Ríos emplea técnicas de liberación
                miofascial y entrenamiento funcional para optimizar la
                recuperación y prevenir lesiones. Su enfoque combina terapia
        ...
        <Col md={6} lg={4} className="mb-4">
          <Card className="caard">
            <Card.Body>
              ...
              <Card.Text>
                Experta en lesiones musculoesqueléticas y post‐quirúrgicas, la
                Dra. Herrera aplica técnicas de movilización articular,
                ejercicios de fortalecimiento y terapias con ultrasonido.
                Atiende casos de hombro congelado, tendinopatías y
        ...
        <Col md={6} lg={4} className="mb-4">
          <Card className="caard">
            <Card.Body>
              ...
              <Card.Text>
                Con formación en fisiología del ejercicio y cuidados intensivos,
                el Dr. Santos lidera programas de rehabilitación para pacientes
                con EPOC, insuficiencia cardíaca y post‐cirugías torácicas.
                Incorpora ejercicio de resistencia, entrenamiento en cinta y
        ...
        <Col md={6} lg={4} className="mb-4">
          <Card className="caard">
            <Card.Body>
              ...
              <Card.Text>
                Apasionada por el desarrollo infantil, la Dra. Fernández trabaja
                con bebés y niños que presentan retrasos motores, parálisis
                cerebral o escoliosis temprana. Emplea juegos terapéuticos,
